...
public class RugSettings {
    ...
    public static class validatorReachDistance extends Validator<Double> {
        ...
        public Double validate(
            ...
            return newValue >= 0
                && newValue <= ( CarpetServer.minecraft_server == null ? 100
                    : CarpetServer.minecraft_server.getPlayerManager().getSimulationDistance() * 16 ) ? newValue : null;
        }
    ...
    @Rule(options = { "0", "1", "2", "3" }, categories = { EXPERIMENTAL, RUG })
